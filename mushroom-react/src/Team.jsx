...
function Team() {
    return (
        <>
            <section id="Team" style={{ width: "98vw" , paddingBottom:"10vh" , background: '#251e18' }} class="bg-white dark:bg-gray-900">
                <div style={{background: '#2e2721'}} class="h-[32rem] bg-gray-100 dark:bg-gray-800">
                    <div class="container px-6 py-10 mx-auto">
                        ...
                        <p class="max-w-4xl mx-auto mt-6 text-center text-gray-500 dark:text-gray-300">
                        Where Mushroom meets Technology. Our team combines the fascinating world of mushrooms with cutting-edge technology to revolutionize the way we understand and utilize these incredible organisms. Together, we explore new frontiers in mushroom research, cultivation, and sustainable solutions.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
                        <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                            <img class="object-cover w-full rounded-xl aspect-square" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt="" />
                                ...
                                <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Cook</p>
                        ...
                        <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                            <img class="object-cover w-full rounded-xl aspect-square" src="https://images.unsplash.com/photo-1531590878845-12627191e687?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80" alt=""/>
                                ...
                                <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Biologist</p>
                        ...
                        <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                            <img class="object-cover w-full rounded-xl aspect-square" src="https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt=""/>
                                ...
                                <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Tech Enthusiast</p>
