...
function Footer() {
    return (
        <>
            <footer style={{ width: "98.9vw" , background:'#395144'  }} class="bg-white dark:bg-gray-900">
                <div class="container px-6 py-8 mx-auto">
                    ...
                    <div class="flex flex-col items-center sm:flex-row sm:justify-between">
                        <p class="text-sm text-gray-500 dark:text-gray-300">© Copyright 2023. All Rights Reserved to harsh joshi.</p>
