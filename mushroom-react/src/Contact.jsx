...
function Contact() {
    return (
        <>
            <section id="Contact" style={{ width: "98vw", background: '#2e2721' }} class="bg-white dark:bg-gray-900">
                <div class="container px-6 py-12 mx-auto">
                    <div>
                        <p class="font-medium text-blue-500 dark:text-[#c39870]">Contact us</p>
                    ...
                    <div class="grid grid-cols-1 gap-12 mt-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        <div style={{background: "#2a231e"}} class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                            ...
                            <p class="mt-2 text-sm text-blue-500 dark:text-[#c39870]">mushroomtech@mushroomtech.com</p>
                        </div>
                        ...
                        <div style={{background: "#2a231e"}} class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                            ...
                            <p class="mt-2 text-sm text-blue-500 dark:text-[#c39870]">12/B , neardns bank, mishra nagar,titwala </p>
                        </div>
                        ...
                        <div style={{background: "#2a231e"}} class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                            ...
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Call anytime whenever</p>
                            <p class="mt-2 text-sm text-blue-500 dark:text-[#c39870]">+91 1234567890</p>
                        </div>
                    </div>
                </div>
            </section>
